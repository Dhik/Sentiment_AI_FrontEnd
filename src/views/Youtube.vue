...
<template>
  ...
  const indonesianStopwords = [
    ...
    "kok", "apa", "tapi", "pak", "tidak", "para", "kalian", "saya", "kan", "klo", "jd", "pd", "sj", "sja", "lg", "orng", "aku", "toh", "bg", "ia", "gue", "a", "hai", "sm", "aq", "kl"
    ...
    deleteItem(index) {
      ...
      async fetchVideos() {
        ...
        try {
          ...
          this.videos = data.comments;
          this.ori_videos = data.comments;
